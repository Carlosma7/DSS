...
public class RegClientActivity extends AppCompatActivity {
    ...
    // Client register into API server
    public void registerClient(String email, String password){
        ...
        HttpPost post = new HttpPost("http://10.0.2.2:8080/MoralesAguileraCarlosSanchezMunozCarlosSantiago/api/clients/register");
        ...
        try {
            ...
            if(responseCode == 201){
                finish();
                Intent intent = new Intent(RegClientActivity.this, MainActivity.class);
                intent.setFlags(Intent.FLAG_ACTIVITY_REORDER_TO_FRONT);
                startActivity(intent);
            }else{
                AlertDialog alertDialog = new AlertDialog.Builder(RegClientActivity.this).create();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Layout elements
        Button regCliButton = this.findViewById(R.id.reg_cli_conf_but);
        ...
        regCliButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                registerClient(emailText.getText().toString(), passwordText.getText().toString());
            }
        });
    }
}